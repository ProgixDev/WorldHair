            ...
            <div className="grid gap-5 lg:grid-cols-[1fr_320px]">
              <div className="flex flex-col gap-4 rounded-2xl bg-[#111c2e] p-6">
                ...
                <textarea
                  ...
                  className="min-h-56 flex-1 resize-none rounded-xl bg-[#080f1a] p-3 text-sm text-[#f2f6fb] placeholder:text-[#5b7186] focus:outline-2 focus:outline-[#2a93d5]"
                />
              ...
              <div className="flex flex-col items-center gap-3 rounded-2xl bg-[#111c2e] p-6">
                ...
                <div
                  className="relative flex w-full max-w-[280px] flex-1 flex-col overflow-hidden rounded-[2rem] border-4 border-[#1e2e45]"
                  style={{ backgroundColor: SLIDE_PALETTE.surface, aspectRatio: "9 / 19.5" }}
                >
                  <div
                    className="absolute inset-x-0 top-1.5 z-10 mx-auto h-4 w-20 rounded-full bg-[#1e2e45]"
                    aria-hidden
                  />
                  ...
                  <div className="flex flex-1 flex-col justify-end gap-2.5 px-4 pt-3 pb-4">
                    <div className="flex flex-col gap-2">
                      ...
                      <p className="text-xs leading-normal" style={{ color: SLIDE_PALETTE.muted }}>
                        {body || "Texte descriptif"}
                      </p>
                    </div>

                    <p
                      className="rounded-full py-2 text-center text-xs font-medium tracking-wide"
                      ...
                      <div className="flex items-center gap-1.5">
                        {Array.from({ length: SLIDE_COUNT }, (_, dotIndex) => (
                          <span
                            ...
                            style={{
                              width: dotIndex === SLIDE_INDEX ? 16 : 4,
                              backgroundColor:
                                dotIndex === SLIDE_INDEX ? "#38b6ff" : SLIDE_PALETTE.muted,
                              opacity: dotIndex === SLIDE_INDEX ? 1 : 0.5,
                            }}
                          />
                        ))}
                      </div>
                      <span className="text-[10px]" style={{ color: SLIDE_PALETTE.muted }}>
